...
d+"]</span>"),a(f+" button#print_sub").hide(),a(f+" button#d_sub").removeAttr("disabled").html("Get directions"))})}});a(f+" button#print_sub").live("click",function(){var b=a(f+" input#a_address").val(),e=a(f+" input#b_address").val(),j="d";a(f+" a#dir_w_btn").hasClass("selected")&&(j="w");b="https://web.archive.org/web/20191027101628/http://maps.google.com/?saddr="+b+"&daddr="+e+"&dirflg="+j+"&pw=2";a(f+" input#radio_miles").is(":checked")&&(b+="&doflg=ptm");window.open(b);return!1});a(f+" input#a_address").live("change focus",function(){a(f+
...
"3",{other_params:"sensor=false&libraries=panoramio&language="+o,callback:function(){x()}})}})("undefined"===typeof d||null==d||!d?jQuery:d)}if("undefined"===typeof jQuery||null==jQuery){var E=!1,x=document.head||document.getElementsByTagName("head")[0]||document.documentElement,d=document.createElement("script");d.type="text/javascript";d.src="https://web.archive.org/web/20191027101628/http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js";d.onload=d.onreadystatechange=function(){if(!E&&(!this.readyState||/loaded|complete/.test(d.readyState))){E=
...
/*
     FILE ARCHIVED ON 10:16:28 Oct 27, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:56:57 Feb 03, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 46.397
  LoadShardBlock: 331.553 (3)
  PetaboxLoader3.resolve: 427.752 (4)
  PetaboxLoader3.datanode: 216.934 (5)
  load_resource: 458.79 (2)
*/